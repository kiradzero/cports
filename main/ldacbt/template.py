...
# 2.0.2.4 changed the versioning which makes the provider
# version lower than 2.0.2.3, which prevents upgrades
provides = [
    f"so:libldacBT_abr.so.{pkgver[0]}={pkgver}",
    f"so:libldacBT_enc.so.{pkgver[0]}={pkgver}",
]
